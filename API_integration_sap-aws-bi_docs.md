...
| --- | --- | --- | --- | --- |
| `sap-client` | — | SAP Client / Mandant Number | String | `100` |
...
```
GET https://devxccre.amer-group.com/sap/ZAWSSALESDATA/CSTDATA
```

**Query Parameters:**

- `sap-client`: SAP client number (required) — `100`
...
GET https://devxccre.amer-group.com/sap/ZAWSSALESDATA/CSTDATA?sap-client=100&COMPCODE=0218

# Filter by company + project
GET https://devxccre.amer-group.com/sap/ZAWSSALESDATA/CSTDATA?sap-client=100&COMPCODE=1001&PROJ=PHLIOPLS

# Filter by company + project + unit
GET https://devxccre.amer-group.com/sap/ZAWSSALESDATA/CSTDATA?sap-client=100&COMPCODE=1001&PROJ=PHLIOPLS&UNIT=A1003
```
...
- All requests require the `sap-client` parameter set to `100`
...
- Confirm `sap-client=100` is correct for the target environment
